        ...
        <tbody>
            <c:forEach items="${events }" var="event">
            	<tr>
	                ...
	                <td><c:out value="${event.getEnvironment() }" /></td>
	                <td><c:out value="${event.getCreator().fullname() }" /></td>
	                <td><c:out value="${event.getExpected_start().toString('MM-dd-yyyy HH:mm:ss') }" />N/A</td>
	                <td><c:out value="${event.getExpected_end().toString('MM-dd-yyyy HH:mm:ss') }" />N/A</td>
	                <td><c:out value="${event.getActual_start().toString('MM-dd-yyyy HH:mm:ss') }" />N/A</td>
	                <td><c:out value="${event.getActual_end().toString('MM-dd-yyyy HH:mm:ss') }" >N/A</c:out></td>
	            </tr>
            </c:forEach>
         </tbody>
    </table>
